...
public class PartialContextExpert<A> extends AbstractExpert<A,String,PartialObject<A,String>> {
     ...
     * The logger.
     */
    private static final Logger logger = Logger.getLogger(PartialContextExpert.class);
     ...
     *
     */
    public PartialContextExpert(PartialContext<A,String,PartialObject<A,String>> context) {
        super();
        theContext = context;
    }
